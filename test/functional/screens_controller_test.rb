...
class ScreensControllerTest < ActionController::TestCase
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post :create, screen: { color: @screen.color, font: @screen.font, name: @screen.name, title: @screen.title }
    end
  ...
  test "should update screen" do
    put :update, id: @screen, screen: { color: @screen.color, font: @screen.font, name: @screen.name, title: @screen.title }
    assert_redirected_to screen_path(assigns(:screen))
  end
